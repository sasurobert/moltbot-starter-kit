...
const discovery_skills_1 = require("../src/skills/discovery_skills");
describe('Discovery Skills', () => {
    ...
    describe('discoverAgents', () => {
        it('should discover agents from registry', async () => {
            ...
            const agents = await (0, discovery_skills_1.discoverAgents)({ maxResults: 5 });
        ...
        it('should respect maxResults', async () => {
            ...
            const agents = await (0, discovery_skills_1.discoverAgents)({ maxResults: 2 });
            expect(agents).toHaveLength(2);
            expect(mockQuery).toHaveBeenCalledTimes(2);
        });
        it('should return empty array when no agents', async () => {
            mockQuery.mockResolvedValueOnce([null]);
            const agents = await (0, discovery_skills_1.discoverAgents)();
        ...
        it('should stop on query error', async () => {
            ...
            const agents = await (0, discovery_skills_1.discoverAgents)({ maxResults: 10 });
            expect(agents).toHaveLength(1);
        });
    });
});
//# sourceMappingURL=discovery_skills.test.js.map