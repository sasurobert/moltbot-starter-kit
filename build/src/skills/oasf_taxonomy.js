...
exports.OASF_DOMAINS = exports.OASF_SKILLS = exports.OASF_SCHEMA_VERSION = void 0;
exports.getSkillCategory = getSkillCategory;
exports.getDomainCategory = getDomainCategory;
exports.getAllSkillIds = getAllSkillIds;
exports.getAllDomainIds = getAllDomainIds;
exports.validateOASF = validateOASF;
exports.OASF_SCHEMA_VERSION = '0.8.0';
...
function getSkillCategory(skillId) {
    const group = exports.OASF_SKILLS.find((g) => g.items.includes(skillId));
    return group?.category;
}
function getDomainCategory(domainId) {
    const group = exports.OASF_DOMAINS.find((g) => g.items.includes(domainId));
    return group?.category;
}
function getAllSkillIds() {
    return exports.OASF_SKILLS.flatMap((g) => g.items);
}
function getAllDomainIds() {
    return exports.OASF_DOMAINS.flatMap((g) => g.items);
}
function validateOASF(manifest) {
    const errors = [];
...
//# sourceMappingURL=oasf_taxonomy.js.map